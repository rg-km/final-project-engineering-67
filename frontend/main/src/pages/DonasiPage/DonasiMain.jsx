...
export default function MainDonation() {
    ...
    const [handleInteger, setHandleInteger] = useState(null);
    const handleInput = (e) => {
        setHandleInteger(e.target.value)
        console.log("taget ", handleInteger)
    }
                ...
                <div className="modal modal-bottom sm:modal-middle">
                    ...
                    <div className="modal-box">
                        ...
                        <div className="form-control w-full max-w-xs">
                            ...
                            <input onChange={handleInput} type="number" name='goal_amount2' placeholder="Type here" className="input input-bordered w-full max-w-xs" />
                            <label className="label">
